...
def main() -> None:
    ...
    checks = [
        _check_equal(
            ...
            summary[("maintrack", "qwen7b", "proof_only", 4096, "depth-3ext-NatLang", "test", "subset_4000")]["joint_accuracy_mean"],
            0.399,
            tol=5e-4,
        ),
        _check_equal(
            "7B 4k ID ProCo joint",
            summary[("maintrack", "qwen7b", "proco", 4096, "depth-3ext-NatLang", "test", "subset_4000")]["joint_accuracy_mean"],
            0.750,
            tol=5e-4,
        ),
        _check_equal(
            "7B 4k Depth-OOD proof-only joint",
            summary[("maintrack", "qwen7b", "proof_only", 4096, "depth-5", "test", "subset_4000")]["joint_accuracy_mean"],
            0.265,
            tol=5e-4,
        ),
        _check_equal(
            "7B 4k Depth-OOD ProCo joint",
            summary[("maintrack", "qwen7b", "proco", 4096, "depth-5", "test", "subset_4000")]["joint_accuracy_mean"],
            0.550,
            tol=5e-4,
        ),
        _check_equal(
        ...
        _check_equal(
            ...
            summary[("maintrack", "qwen7b", "proco", 112062, "depth-3ext-NatLang", "test", "subset_4000")]["accuracy_mean"],
            0.982,
            tol=5e-4,
        ),
        _check_equal(
            "Full-train ID ProCo joint",
            summary[("maintrack", "qwen7b", "proco", 112062, "depth-3ext-NatLang", "test", "subset_4000")]["joint_accuracy_mean"],
            0.968,
            tol=5e-4,
        ),
        _check_equal(
            "Full-train Depth-OOD ProCo accuracy",
            summary[("maintrack", "qwen7b", "proco", 112062, "depth-5", "test", "subset_4000")]["accuracy_mean"],
            0.938,
            tol=5e-4,
        ),
        _check_equal(
            "Full-train Depth-OOD ProCo joint",
            summary[("maintrack", "qwen7b", "proco", 112062, "depth-5", "test", "subset_4000")]["joint_accuracy_mean"],
            0.862,
            tol=5e-4,
        ),
        _check_equal(
            "Qwen support-deletion answer-only predicted unknown",
            unknown[("mutation", "qwen7b", "answer_only", 4096, "support-deletion", "test", "subset_4000")]["predicted_unknown_mean"],
            2248.0,
            tol=0.11,
        ),
        _check_equal(
            "Qwen support-deletion proof-only predicted unknown",
            unknown[("mutation", "qwen7b", "proof_only", 4096, "support-deletion", "test", "subset_4000")]["predicted_unknown_mean"],
            2412.0,
            tol=0.11,
        ),
        _check_equal(
            "Qwen support-deletion ProCo predicted unknown",
            unknown[("mutation", "qwen7b", "proco", 4096, "support-deletion", "test", "subset_4000")]["predicted_unknown_mean"],
            2187.3,
            tol=0.11,
        ),
        _check_equal(
